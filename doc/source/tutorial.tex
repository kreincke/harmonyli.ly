...
trisChord = \lyricmode {
  ...
  \markup \setHas "E" #'(("a"." ")("b"." ")("c"." "))   
     ...
     \markup \setRfHas "gis" "Cis" 
    #'( ("B"."6")("a"."5")("b"."6")
        ("nT"."x")("nB"."3")("na"."7")("nb"."9")
    )
  
  
  \markup \setHas "fis" #'(("B"."3")("a"." ")("b"." ")("c"." ")("d"." ")("e"." "))
  \initTextSpan "      "  
...
.2 cadenca-functional-harmony-theory.ly \com{example}.
.2 cadenca-scale-step-theory.ly \com{example}.
...
.2 modulation-functional-harmony-theory.ly \com{example}.
.2 modulation-scale-step-theory.ly \com{example}.
